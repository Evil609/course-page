    ...
    <div className="p-4 w-full md:w-1/3 xl:w-2/5 pt-10">
      ...
      <div className="flex flex-col items-center justify-center w-full bg-gray-100">
        <div className="relative w-full h-2">
          ...
          <div
            className="absolute bottom-10 w-10 h-10 bg-white rounded-full flex items-center justify-center text-xs font-bold text-blue-900 shadow-md transform -translate-x-1/2 border-4 border-solid border-gray-400"
            style={{ left: `${progress}%` }}
          >
            You
